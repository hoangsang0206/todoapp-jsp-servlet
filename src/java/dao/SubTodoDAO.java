...
public class SubTodoDAO {
    ...
    public ArrayList<SubTodo> getSubTodoList(String todoID) {
        try {
    ...
    public SubTodo getTodo(String subTodoId) {
        try {
            JDBCConnect connect = new JDBCConnect();
            connect.getConnection();
    ...
    public boolean createTodo(SubTodo subTodo) {
        JDBCConnect connect = new JDBCConnect();
        connect.getConnection();
    ...
    public boolean deleteTodo(SubTodo subTodo) {
        JDBCConnect connect = new JDBCConnect();
        connect.getConnection();
    ...
    public boolean updateTodo(SubTodo subTodo) {
        JDBCConnect connect = new JDBCConnect();
        connect.getConnection();
