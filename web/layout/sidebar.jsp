        ...
        <div class="nav-contents">
            <div class="nav-item">
                ...
                <ul class="nav-item-list">
                    <li>
                        <a class="nav-link d-flex align-items-center justify-content-between active" href="index.html">
                    ...
                    <li>
                        <a class="nav-link d-flex align-items-center justify-content-between" href="today.html">
                            <div class="nav-link-box d-flex align-items-center">
                                <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24">
