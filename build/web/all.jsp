...
<html>
    <head>
        ...
        <title><fmt:message bundle="${bundle}" key="title_all" /></title>
    ...
    <body>
        ...
        <section class="main-layout d-flex">
            ...
            <main>
                ...
                <section class="main-contents all-page">
                    <jsp:include page="layout/view_action.jsp" />
                    
                    <c:set var="upcomingTodoList" value="${requestScope.Upcoming}" />
                    <c:set var="todayTodoList" value="${requestScope.TodayTodoList}" />
                    <c:set var="weekTodoList" value="${requestScope.WeekTodoList}" />
                    <c:set var="beforeWeekTodoList" value="${requestScope.BeforeWeekTodoList}" />
                    ...
                    <c:choose>
                        <c:when test="${view == 'grid'}">
                            ...
                            <div class="tasks-box before mt-3">
                                <div class="task-list-title d-flex align-items-center gap-3">
                                    <span>Trước đó</span>
                                    <ion-icon class="show-hide-tasks" name="caret-up-outline"></ion-icon>
                                </div>
